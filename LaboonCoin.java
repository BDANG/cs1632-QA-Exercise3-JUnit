...
public class LaboonCoin {
    ...
    public int hash(String data) {
        ...
        char[] sequence_of_chars = data.toCharArray();
        int n = 10000000;
        for (int i = 0; i < sequence_of_chars.length; i++) {

            n = n * (int) sequence_of_chars[i];
            n = n + (int) sequence_of_chars[i];
    ...
    public boolean validHash(int difficulty, int hash) {
        int maxHexLength = 8 - difficulty;
        String hex = Integer.toHexString(hash);
        //System.out.println(hex+" "+hex.length().toString()+" "+max)
